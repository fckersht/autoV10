...
[bold green]░╚═══██╗██╔══╝░░██╔══██╗░╚████╔╝░██╔══╝░░██╔══██╗  ██╔══╝░░
[bold green]██████╔╝███████╗██║░░██║░░╚██╔╝░░███████╗██║░░██║  ███████╗
[bold green]╚═════╝░╚══════╝╚═╝░░╚═╝░░░╚═╝░░░╚══════╝╚═╝░░╚═╝  ╚══════╝░[green_yellow][bold]VERSION/3.0
          [green_yellow]MY [dark_olive_gre]SYSTEM[pale_green1] IS[dark_sea_green…] DIFFERENT BRO
""")
ll=str([hari,tanggal])
hx=(f"""  [bold green_yellow]DEVELOPER[medium_purple1]   ⟩ [bold cyan2] Veen
  [bold red]FACEBOOK[medium_purple1]    ⟩ [bold cyan1] Test server 1 
  [bold red]STATUS[medium_purple1]  ⟩ [bold cyan1]ACTIVE until feb 28, 2025
  [bold red]TOOL[medium_purple1] ⟩ [bold cyan1]Test Server
