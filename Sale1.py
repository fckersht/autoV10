...
{blue}╰──────────────────{C} D E V E L O P E R  S Y T H E {blue}──────────────────────────╯
 ...
 │ {red}•{hotpink} OWNER   : {green}YUSH HUILEN     {blue}    │   {blue} │ {red}• {hotpink}STATUS   : {green}ACTIVE        {blue}     │
 │{red} • {hotpink}USES    : {green}BOOSTING       {blue}     │ {blue}   │ {red}• {hotpink}COUNTRY  :{green} PHILIPPINES    {blue}    │
 │{red} • {hotpink}NETWORK : {green}ALL NETWORK     {blue}    │   {blue} │ {red}• {hotpink}TELEGRAM : {green}@SYTHE13         {blue}  │
...
def main():
    ...
    jovan()
    print(f""" {blue}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m""")
    print(f""" {blue}┃                   {hotpink} ACCOUNT AND PAGE OVERVIEWS 📌           {blue}             ┃""")
    print(f""" {blue}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛   
                            {green}FRA ACCOUNT{yellow} : {green}{total_accounts}
                            {green}FRA PAGES  {yellow} : {green}{total_pages}
                            {green}RPW ACCOUNT{yellow} : {green}{ total_account_rpw}
                            {green}RPW PAGES  {yellow} : {green}{total_pages_rpw} """)
                            
    print(f"{blue}┏━━━━━━━━━━━━━━━━━━━━━━ {hotpink}T O O L  S E R V I C E S{blue} ━━━━━━━━━━━━━━━━━━━━━━━━━━┓")
    print(f"{blue}┃  {green}[01] {red} 𝗦𝘁𝗮𝗿𝘁 𝗧𝗼𝗼𝗹𝘀                          {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {blue}    ┃")
    print(f"{blue}┃  {green}[02]  {white}𝗔𝗨𝗧𝗢 𝗥𝗘𝗔𝗖𝗧{yellow} 𝗣𝗢𝗦𝗧                      {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {blue}    ┃")
    print(f"{blue}┃  {green}[03]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 {yellow}𝐑𝐄𝐄𝐋𝐒                     {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {blue}  ┃")
    print(f"{blue}┃  {green}[04]  {white}𝗔𝗨𝗧𝗢 𝗥𝗘𝗔𝗖𝗧 {yellow}𝗚𝗥𝗢𝗨𝗣 𝗣𝗢𝗦𝗧                {yellow}- {green}[ 𝗣𝗔𝗚𝗘 𝗢𝗥 ACCOUNT ]     {blue}   ┃")
    print(f"{blue}┃  {green}[05]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓{yellow} [ 𝐕𝐈𝐃𝐄𝐎 𝐎𝐑 𝐏𝐇𝐎𝐓𝐎 ]        {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {blue}   ┃")
    print(f"{blue}┃  {green}[06]  {white}𝐀𝐔𝐓𝐎 {yellow}𝐅𝐎𝐋𝐋𝐎𝐖                          {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]       {blue} ┃")
    print(f"{blue}┃  {green}[07]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 {yellow}𝐃𝐏/𝐏𝐎𝐒𝐓                   {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {blue}    ┃")
    print(f"{blue}┃  {green}[08]  {white}𝐀𝐔𝐓𝐎 {yellow}𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                        {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {blue}   ┃")
    print(f"{blue}┃  {green}[09]  {white}𝐀𝐔𝐓𝐎 {yellow}𝐅𝐎𝐋𝐋𝐎𝐖 & 𝐋𝐈𝐊𝐄 𝐏𝐀𝐆𝐄              {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]    {blue}    ┃")
    print(f"{blue}┃  {green}[10]  {white}𝐀𝐔𝐓𝐎 𝐒𝐇𝐀𝐑𝐄{yellow} [ 𝐕𝐈𝐀 𝐂𝐎𝐎𝐊𝐈𝐄𝐒 ]           {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {blue}  ┃")
    print(f"{blue}┃  {green}[11]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 {yellow}𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                  {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {blue}   ┃")
    print(f"{blue}┃  {green}[12]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐏𝐋𝐘 {yellow}𝐂𝐎𝐌𝐌𝐄𝐍𝐓𝐒                  {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {blue}   ┃")
    print(f"{blue}┃  {green}[13]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐏𝐎𝐒𝐓 {yellow}( 𝐖/𝐂𝐀𝐑𝐄 )           {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {blue}   ┃")
    print(f"{blue}┃  {green}[14]  {white}𝐀𝐔𝐓𝐎 𝐆𝐑𝐎𝐔𝐏 {yellow}𝐉𝐎𝐈𝐍                      {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {blue}   ┃")
    print(f"{blue}┃  {green}[15]  {white}𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 {yellow}𝐋𝐈𝐕𝐄 𝐒𝐓𝐑𝐄𝐀𝐌               {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {blue}   ┃")
    print(f"{blue}┃  {green}[16]  {white}𝐀𝐔𝐓𝐎 𝐂𝐎𝐌𝐌𝐄𝐍𝐓 {yellow}𝐋𝐈𝐕𝐄 𝐒𝐓𝐑𝐄𝐀𝐌             {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]     {blue}   ┃")
    print(f"{blue}┃  {green}[17]{white}  𝐑𝐄𝐒𝐄𝐓 𝐓𝐎𝐎𝐋𝐒                          {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]      {blue}  ┃")
    print(f"{blue}┃  {green}[18]{white}  𝐀𝐔𝐓𝐎 𝐂𝐑𝐄𝐀𝐓𝐄 {yellow}𝐏𝐀𝐆𝐄                     {yellow}- {green}[ 𝐏𝐇 𝐍𝐀𝐌𝐄 ]          {blue}      ┃")
    print(f"{blue}┃  {green}[19] {white} 𝐀𝐔𝐓𝐎 𝐒𝐄𝐓 {yellow}𝐏𝐅𝐎𝐅𝐈𝐋𝐄                     {yellow}- {green}[ 𝐑𝐀𝐍𝐃𝐎𝐌 ]             {blue}    ┃")
    print(f"{blue}┃  {green}[20] {white} 𝐂𝐑𝐄𝐀𝐓𝐄 {yellow}𝐅𝐈𝐋𝐄                          {yellow}- {green}[ 𝐑𝐀𝐍𝐃𝐎𝐌 ]            {blue}     ┃")
    print(f"{blue}┃  {green}[21] {white} 𝐑𝐄𝐌𝐎𝐕𝐄 {yellow}𝐃𝐔𝐏𝐋𝐈𝐂𝐀𝐓𝐄                     {yellow}- {green}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐑𝐎𝐌𝐎𝐕𝐄𝐑 ]    {blue}    ┃")
    print(f"{blue}┃  {green}[22]  {white}𝐀𝐂𝐂𝐎𝐔𝐍𝐓 {yellow}𝐂𝐇𝐄𝐂𝐊𝐄𝐑                      {yellow}- {green}[ 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 ]  {blue}      ┃")
    print(f"{blue}┃  {green}[23]  {white}𝐕𝐀𝐋𝐈𝐃𝐀𝐓𝐄 {yellow}𝐓𝐎𝐊𝐄𝐍                       {yellow}- {green}[ 𝐓𝐎𝐊𝐄𝐍 ]             {blue}     ┃")
    print(f"{blue}┃  {green}[24]  {white}𝐑𝐄𝐃𝐄𝐄𝐌 {yellow}𝐀𝐂𝐂𝐎𝐔𝐍𝐓                       {yellow}- {green}[ 𝐑𝐄𝐃𝐄𝐌𝐓𝐈𝐎𝐍𝐒 ]      {blue}       ┃") 
    print(f"{blue}┃  {green}[25]  {white}𝐀𝐔𝐓𝐎 {yellow}𝐒𝐇𝐀𝐑𝐄 𝐕1                        {yellow}- {green}[ 𝐅𝐀𝐒𝐓 𝐒𝐏𝐄𝐄𝐃 / 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 ] {blue}  ┃") 
    print(f"{blue}┃  {green}[26]  {white}𝐀𝐔𝐓𝐎 {yellow}𝐒𝐇𝐀𝐑𝐄 𝐕2                        {yellow}- {green}[ 𝐅𝐀𝐒𝐓 𝐒𝐏𝐄𝐄𝐃 / 𝐏𝐔𝐁𝐋𝐈𝐂 ]   {blue} ┃") 
    print(f"{blue}┃ {green} [27]  { white}𝐂𝐎𝐎𝐊𝐈𝐄𝐒/𝐓𝐎𝐊𝐄𝐍                        {yellow}- {green}[ 𝐆𝐄𝐓𝐓𝐄𝐑 ] {blue}                ┃")
    print(f"{blue}┃ {green} [28] {white} 𝐅𝐎𝐋𝐋𝐎𝐖𝐄𝐑 {yellow}𝐑𝐄𝐌𝐎𝐕𝐄𝐑                     {yellow}- {green}[ 𝐑𝐄𝐌𝐎𝐕𝐄𝐑 ] {blue}               ┃")
    print(f"{blue}┃ {green} [29] {white} 𝐀𝐔𝐓𝐎 𝐑𝐄𝐀𝐂𝐓 𝐕2 𝐖𝐈𝐓𝐇 {yellow}𝐑𝐄𝐌𝐎𝐕𝐄𝐑           {yellow}- {green}[ 𝐑𝐄𝐌𝐎𝐕𝐄𝐑 ]         {blue}       ┃")
    print(f"{blue}┃ {green} [30] {red} 𝐓𝐎𝐎𝐋𝐒 𝐔𝐏𝐃𝐀𝐓𝐄                         {yellow}- {green}[ 𝐔𝐏𝐃𝐀𝐓𝐈𝐍𝐆 ]         {blue}      ┃")
    print(f"{blue}┃  {green}[31]  {white}𝐀𝐔𝐓𝐎 {yellow}𝐅𝐎𝐋𝐋𝐎𝐖   V2                     {yellow}- {green}[ 𝐏𝐀𝐆𝐄 𝐎𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 ]       {blue} ┃")
    print(f"{blue}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m")
    choice = input(f"     {green}CHOICE: ").strip()         
